                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <input hidden type="file" accept="image/*"
                                    id="profile_picture" className='w-full p-3 border border-gray-200 rounded-lg'
                        ...
                        <div>
                            ...
                            rounded-lg' placeholder='Please enter your full name' onChange=
                            {(e) => setEditForm({...editForm, full_name: e.target.value})} value=
                            {editForm.full_name} />
                        </div>
                        {/* Username */}
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200
                            rounded-lg' placeholder='Please enter your username' onChange=
                            {(e) => setEditForm({...editForm, username: e.target.value})} value=
                            {editForm.username} />
                        </div>
                        {/* Bio */}
                        <div>
                            ...
                            rounded-lg' placeholder='Please enter your bio' onChange=
                            {(e) => setEditForm({...editForm, bio: e.target.value})} value=
                            {editForm.bio} />
                        </div>
                        {/* Location */}
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200
                            rounded-lg' placeholder='Please enter your location' onChange=
                            {(e) => setEditForm({...editForm, location: e.target.value})} value=
                            {editForm.location} />
                        </div>
                        ...
                        <div className='flex justify-end space-x-3 pt-6'>
                            ...
                            text-gray-700 hover:bg-gray-500 transition-colors
